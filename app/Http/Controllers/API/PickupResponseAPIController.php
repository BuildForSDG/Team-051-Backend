...
class PickupResponseAPIController extends AppBaseController
{
    ...
    public function show($id)
    {
        ...
        $pickupResponse = $this->pickupResponseRepository->find($id);
     ...
     * @return Response
     */
    public function update($id, UpdatePickupResponseAPIRequest $request)
    {
        $input = $request->all();
        ...
        $pickupResponse = $this->pickupResponseRepository->update($input, $id);
